...
class Configuration:
    ...
    # Model
    model: str = "BEMN-Tiny" # BEMN-Tiny, BEMN-Small, BEMN-Base
    ...
    if "Tiny" in model:
        checkpoint_start = './checkpoint/university/BEMN-Tiny-1/weights_e1_0.9485.pth'
    elif "Small" in model:
        checkpoint_start = './checkpoint/university/BEMN-Small-1/weights_e1_0.9536.pth'
    elif "Base" in model:
        checkpoint_start = './checkpoint/university/BEMN-Base-1/weights_e1_0.9574.pth'
...
if __name__ == '__main__':
    ...
    if config.checkpoint_start is not None:
        ...
        model_state_dict = torch.load(config.checkpoint_start, map_location='cuda:0')
